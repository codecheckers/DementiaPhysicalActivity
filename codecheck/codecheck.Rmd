...
Code was written in `R`. Running the current version of the R script `PlottingScripts.R` yields all necessary output files. This took 1 minute to complete on a Windows 10 laptop.
