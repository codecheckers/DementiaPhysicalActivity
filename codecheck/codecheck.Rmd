...
The repository could be downloaded from GitHub and the `PlottingScripts.R` file contained all code required to produce the three figures in the paper. There were some initial issues with the raw data files not being available. One of the authors of the paper (Daniela Gawehns) provided aggregate data, and edited the R script to remove any code dependent on the raw data.
